...
tBog gExpression[]=
        ...
        /*2*/{BgGr, {(ul)gTerm}, NULL, 3, 0},
        /*3*/{BgNl, {(ul)0}, NULL, 4, 6},
        /*4*/{BgSy, {(ul) '+'}, NULL, 5, 0},
        /*5*/{BgGr, {(ul)gTerm}, NULL, 3, 0},
        /*6*/{BgSy, {(ul) '-'}, NULL, 7, 0},
        /*7*/{BgGr, {(ul)gTerm}, NULL, 3, 0},
        /*8*/{BgEn, {(ul)0}, NULL, 0, 0},
        };
...
tBog gStatement[]=
        ...
        /*12*/{BgGr,{(ul)gStatement }, NULL, 14 ,13},
        /*13*/{BgSy,{(ul)zEND       }, NULL, 22 ,0},
